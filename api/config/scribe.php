...
return [
    ...
    // Use APP_URL or fall back to localhost:8000 for local Docker/dev usage.
    'base_url' => env('SCRIBE_BASE_URL', env('APP_URL', 'http://localhost:8000')),
    ...
    'auth' => [
        ...
        'extra_info' => 'Use the token returned by <code>POST /api/auth/login</code> or <code>POST /api/auth/register</code> in the Authorization header as <code>Bearer {token}</code>.',
    ],
