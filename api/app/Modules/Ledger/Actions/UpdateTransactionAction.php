...
final readonly class UpdateTransactionAction
{
    ...
    public function execute(Transaction $transaction, PostManualTransactionData $payload): Transaction
    {
        if ($transaction->settlement_id !== null) {
            throw new InvalidLedgerPostingException('Cannot update a transaction that has been settled.');
        }
