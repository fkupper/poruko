                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-ledgers--ledger_id--accounts">POST api/ledgers/{ledger_id}/accounts</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-ledgers--ledger_id--accounts--account_id-">
                                <a href="#endpoints-GETapi-ledgers--ledger_id--accounts--account_id-">GET api/ledgers/{ledger_id}/accounts/{account_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PATCHapi-ledgers--ledger_id--accounts--account_id-">
                                <a href="#endpoints-PATCHapi-ledgers--ledger_id--accounts--account_id-">PATCH api/ledgers/{ledger_id}/accounts/{account_id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-ledgers--ledger_id--accounts--account_id-">
                                <a href="#endpoints-DELETEapi-ledgers--ledger_id--accounts--account_id-">DELETE api/ledgers/{ledger_id}/accounts/{account_id}</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-ledgers--ledger_id--transactions">POST api/ledgers/{ledger_id}/transactions</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-ledgers--ledger_id--transactions--transaction_id-">
                                <a href="#endpoints-GETapi-ledgers--ledger_id--transactions--transaction_id-">GET api/ledgers/{ledger_id}/transactions/{transaction_id}</a>
                            </li>
                                                                        </ul>
                            </ul>
...
<p>Must not be greater than 255 characters. Example: <code>n</code></p>
                    ...
                    <h2 id="endpoints-GETapi-ledgers--ledger_id--accounts--account_id-">GET api/ledgers/{ledger_id}/accounts/{account_id}</h2>
...
<span id="example-requests-GETapi-ledgers--ledger_id--accounts--account_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-ledgers--ledger_id--accounts--account_id-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-ledgers--ledger_id--accounts--account_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-ledgers--ledger_id--accounts--account_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-ledgers--ledger_id--accounts--account_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-ledgers--ledger_id--accounts--account_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-ledgers--ledger_id--accounts--account_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-ledgers--ledger_id--accounts--account_id-" data-method="GET"
      data-path="api/ledgers/{ledger_id}/accounts/{account_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-ledgers--ledger_id--accounts--account_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-ledgers--ledger_id--accounts--account_id-"
                    onclick="tryItOut('GETapi-ledgers--ledger_id--accounts--account_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-ledgers--ledger_id--accounts--account_id-"
                    onclick="cancelTryOut('GETapi-ledgers--ledger_id--accounts--account_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-ledgers--ledger_id--accounts--account_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/ledgers/{ledger_id}/accounts/{account_id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-ledgers--ledger_id--accounts--account_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-ledgers--ledger_id--accounts--account_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="ledger_id"                data-endpoint="GETapi-ledgers--ledger_id--accounts--account_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the ledger. Example: <code>1</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="account_id"                data-endpoint="GETapi-ledgers--ledger_id--accounts--account_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the account. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-PATCHapi-ledgers--ledger_id--accounts--account_id-">PATCH api/ledgers/{ledger_id}/accounts/{account_id}</h2>
...
<span id="example-requests-PATCHapi-ledgers--ledger_id--accounts--account_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PATCHapi-ledgers--ledger_id--accounts--account_id-">
</span>
<span id="execution-results-PATCHapi-ledgers--ledger_id--accounts--account_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PATCHapi-ledgers--ledger_id--accounts--account_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PATCHapi-ledgers--ledger_id--accounts--account_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PATCHapi-ledgers--ledger_id--accounts--account_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PATCHapi-ledgers--ledger_id--accounts--account_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PATCHapi-ledgers--ledger_id--accounts--account_id-" data-method="PATCH"
      data-path="api/ledgers/{ledger_id}/accounts/{account_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PATCHapi-ledgers--ledger_id--accounts--account_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PATCHapi-ledgers--ledger_id--accounts--account_id-"
                    onclick="tryItOut('PATCHapi-ledgers--ledger_id--accounts--account_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-ledgers--ledger_id--accounts--account_id-"
                    onclick="cancelTryOut('PATCHapi-ledgers--ledger_id--accounts--account_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PATCHapi-ledgers--ledger_id--accounts--account_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PATCHapi-ledgers--ledger_id--accounts--account_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PATCHapi-ledgers--ledger_id--accounts--account_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="ledger_id"                data-endpoint="PATCHapi-ledgers--ledger_id--accounts--account_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the ledger. Example: <code>1</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="account_id"                data-endpoint="PATCHapi-ledgers--ledger_id--accounts--account_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the account. Example: <code>1</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PATCHapi-ledgers--ledger_id--accounts--account_id-"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="type"                data-endpoint="PATCHapi-ledgers--ledger_id--accounts--account_id-"
               value="personal"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="owner_id"                data-endpoint="PATCHapi-ledgers--ledger_id--accounts--account_id-"
               value="16"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the users table. Example: <code>16</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="code"                data-endpoint="PATCHapi-ledgers--ledger_id--accounts--account_id-"
               value="n"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>n</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-ledgers--ledger_id--accounts--account_id-">DELETE api/ledgers/{ledger_id}/accounts/{account_id}</h2>
...
<span id="example-requests-DELETEapi-ledgers--ledger_id--accounts--account_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-ledgers--ledger_id--accounts--account_id-">
</span>
<span id="execution-results-DELETEapi-ledgers--ledger_id--accounts--account_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-ledgers--ledger_id--accounts--account_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-ledgers--ledger_id--accounts--account_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-ledgers--ledger_id--accounts--account_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-ledgers--ledger_id--accounts--account_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-ledgers--ledger_id--accounts--account_id-" data-method="DELETE"
      data-path="api/ledgers/{ledger_id}/accounts/{account_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-ledgers--ledger_id--accounts--account_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-ledgers--ledger_id--accounts--account_id-"
                    onclick="tryItOut('DELETEapi-ledgers--ledger_id--accounts--account_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-ledgers--ledger_id--accounts--account_id-"
                    onclick="cancelTryOut('DELETEapi-ledgers--ledger_id--accounts--account_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-ledgers--ledger_id--accounts--account_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-ledgers--ledger_id--accounts--account_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-ledgers--ledger_id--accounts--account_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="ledger_id"                data-endpoint="DELETEapi-ledgers--ledger_id--accounts--account_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the ledger. Example: <code>1</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="account_id"                data-endpoint="DELETEapi-ledgers--ledger_id--accounts--account_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the account. Example: <code>1</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="2026-03-10T23:42:30"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-03-10T23:42:30</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after or equal to <code>from_date</code>. Example: <code>2052-04-02</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>account_id</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Example: <code>reversal</code></p>
Must be one of:
...
Must be one of:
<ul style="list-style-type: square;"><li><code>equal</code></li> <li><code>individual</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
        <details>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="participants.0.account_id"                data-endpoint="POSTapi-ledgers--ledger_id--transactions"
               value="16"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the accounts table. Example: <code>16</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="participants.0.amount"                data-endpoint="POSTapi-ledgers--ledger_id--transactions"
               value="39"
               data-component="body">
    <br>
<p>This field is required when <code>split_rule</code> is <code>individual</code>. Must be at least 0. Example: <code>39</code></p>
                    </div>
                                    </details>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-ledgers--ledger_id--transactions--transaction_id-">GET api/ledgers/{ledger_id}/transactions/{transaction_id}</h2>
...
<span id="example-requests-GETapi-ledgers--ledger_id--transactions--transaction_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-ledgers--ledger_id--transactions--transaction_id-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-ledgers--ledger_id--transactions--transaction_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-ledgers--ledger_id--transactions--transaction_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-ledgers--ledger_id--transactions--transaction_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-ledgers--ledger_id--transactions--transaction_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-ledgers--ledger_id--transactions--transaction_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-ledgers--ledger_id--transactions--transaction_id-" data-method="GET"
      data-path="api/ledgers/{ledger_id}/transactions/{transaction_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-ledgers--ledger_id--transactions--transaction_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-ledgers--ledger_id--transactions--transaction_id-"
                    onclick="tryItOut('GETapi-ledgers--ledger_id--transactions--transaction_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-ledgers--ledger_id--transactions--transaction_id-"
                    onclick="cancelTryOut('GETapi-ledgers--ledger_id--transactions--transaction_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-ledgers--ledger_id--transactions--transaction_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/ledgers/{ledger_id}/transactions/{transaction_id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-ledgers--ledger_id--transactions--transaction_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-ledgers--ledger_id--transactions--transaction_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="ledger_id"                data-endpoint="GETapi-ledgers--ledger_id--transactions--transaction_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the ledger. Example: <code>1</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="transaction_id"                data-endpoint="GETapi-ledgers--ledger_id--transactions--transaction_id-"
               value="1"
               data-component="url">
    <br>
